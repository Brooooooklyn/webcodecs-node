...
function generateAnimatedGIF(width, height) {
  ...
  gct[0] = 0; gct[1] = 0; gct[2] = 0; // black
  gct[3] = 255; gct[4] = 255; gct[5] = 255; // white
  parts.push(gct);
  ...
  parts.push(Buffer.from([
    ...
    0x32, 0x2E, 0x30, // 2.0
    0x03, 0x01, 0x00, 0x00, // Sub-block size, index 1, loop count (0 = infinite)
  ...
  for (let i = 0; i < colors.length; i++) {
    ...
    parts.push(Buffer.from([
      0x21, 0xF9, 0x04, // Extension introducer, Graphic control, block size
      0x04,             // Disposal method: don't dispose
      0x64, 0x00,       // Delay time (100ms = 10 in 1/100 sec units)
