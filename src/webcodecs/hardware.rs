...
pub fn get_hardware_accelerators() -> Vec<HardwareAccelerator> {
    let accelerators = [
        (AVHWDeviceType::Videotoolbox, "videotoolbox", "Apple VideoToolbox (macOS)"),
        (AVHWDeviceType::Cuda, "cuda", "NVIDIA CUDA/NVENC"),
        (AVHWDeviceType::Vaapi, "vaapi", "Video Acceleration API (Linux)"),
        (AVHWDeviceType::D3d11va, "d3d11va", "Direct3D 11 Video Acceleration (Windows)"),
        (AVHWDeviceType::Qsv, "qsv", "Intel Quick Sync Video"),
        (AVHWDeviceType::Dxva2, "dxva2", "DirectX Video Acceleration 2 (Windows)"),
